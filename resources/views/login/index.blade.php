                ...
                <main class="mt-3 form-signin w-100 m-auto">
                    <form action="{{ route('login-mahasiswa.store') }}" method="post">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="login" class="form-control @error('login') is-invalid @enderror" id="login" placeholder="npm anda" required autofocus value="{{ old('login') }}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="token" class="form-control @error('token') is-invalid @enderror" id="token" placeholder="npm anda" autofocus value="{{ old('token') }}">
