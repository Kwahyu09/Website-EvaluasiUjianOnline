...
<div class="card">
  <div class="card-body">
    ...
    <div class="d-flex justify-content-start">
      <a href="/evaluasi/create" class="btn btn-primary">Tambah Data <i class="bi bi-plus-circle"></i></a>
    </div>
    @if ($post->count())
      ...
      <div class="col-md-12">
        @if(session()->has('success'))
          <div class="alert alert-success alert-block">
              {{ session('success') }}
              <button type="button" class="close" data-dismiss="alert"><a href="/evaluasi" style="text-decoration: none;">×</a></button>
          </div>
        @endif
