        ...
        <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  ...
                  <form action="/modul/{{ $post->slug }}" method="post">
                    ...
                    @csrf
                    <div class="card-body">
                        <input type="hidden" name="kd_modul" class="form-control" id="kd_modul" value="{{ $post->kd_modul }}">
                        <div class="form-group">
                            <label for="nama_modul">Nama Modul</label>
                            <input type="text" name="nama_modul" class="form-control @error('nama_modul') is-invalid @enderror" id="nama_modul" required value="{{ old('nama_modul', $post->nama_modul) }}">
                            @error('nama_modul')
