                  ...
                  <form action="/dosen/{{ $post->slug }}" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_dos" class="form-control @error('nama_dos') is-invalid @enderror" id="nama_dos" required value="{{ old('nama_dos', $post->nama_dos) }}">
                            @error('nama_dos')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-check-input" type="radio" name="jenis_kel" id="jenis_kel" value="Laki-Laki" <?php if($post->jenis_kel =='Laki-Laki') echo 'checked'?>>
                                <label class="form-check-label" for="jenis_kel">Laki-laki</label>
                                </div>
                                <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="jenis_kel" id="jenis_kel" value="Perempuan" <?php if($post->jenis_kel =='Perempuan') echo 'checked'?>>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="prodi" name="prodi" class="form-control  @error('prodi') is-invalid @enderror" id="prodi" required value="{{ old('prodi', $post->prodi) }}">
                                    @error('prodi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
